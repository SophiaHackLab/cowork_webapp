    ...
    <div class="flex flex-col">
        <NuxtLink
            ...
            <div class="flex items-center gap-[10px] text-base">
                <div class="group-active:scale-[0.98] transition-all text-fg-secondary w-6 h-6" :class="{
                    '!text-fg-main/80': isRouterLinkActive,
                    'group-hover:!text-fg-main/70': !isRouterLinkActive,
                }">
                    <slot name="icon" />
                </div>
                <p class="text-sm font-semibold text-fg-secondary group-hover:!text-fg-main" :class="{
            ...
            <div v-if="notifs && !isRouterLinkActive && !slots.subItems"
